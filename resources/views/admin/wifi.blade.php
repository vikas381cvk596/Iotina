    ...
    <div class="container-fluid">
                        ...
                        <div class="form-group" style="width: 15vw;">
                          ...
                          <div class="dropdown sp_dropdown" style="">
                            ...
                            <div class="dropdown-menu" id="sp_dropdown_options" aria-labelledby="sp_dropdown">
                              <a class="dropdown-item" style="" data-value="WPA2"><span class="title_text_dropdown" style="font-size: 14px; font-weight: 600;">WPA2 (Recommended)</span></a>
                              <a class="dropdown-item" style="" data-value="WPA"><span class="title_text_dropdown" style="font-size: 14px; font-weight: 600;">WPA</span></a>
                            </div>
                          </div>
                        </div>
                      </div>
      ...
      <div class="edit_network_block" class="row" style="display: block;">
        ...
        <div class="col-lg-12">
          <div class="card mb-3">
            <div class="card-header">
              <i class="fa fa-wifi"></i>&nbsp;&nbsp;Edit WiFi Network
            </div>
            ...
            <div class="row" style="margin-top: 20px;">
              <div class="col-md-12">
                <div style="display: flex; flex-direction: row; align-items: flex-start; justify-content: flex-start;">
                  ...
                  <!-- Left Section Forms --> 
                  <div style="display: flex; flex-direction: column; align-items: flex-start; justify-content: center; padding-left: 80px; width: 70%; border-right: 1px solid #e8e8e8" class="left_section_edit">
                    <div style="display: flex; flex-direction: column;" class="form_class_edit form_step_1_edit active" form-step='form_step_1_edit'>
                      <div style="display: flex; flex-direction: row; align-items: center; justify-content: flex-start; width: 30vw;">
                        <div class="form-group" style="width: 20vw;">
                          <div style="text-align: left; font-size: 14px; color: #696969; font-weight: 600;">* Name</div>
                          <div class='input-group'>
                            <input type="text" id="network_name_edit" name="network_name_edit" class="form-control form-fields" class="form-control" placeholder="Network Name" style="font-size: 14px;"/>
                          </div>
                          <div class='error-text-network-name' style="text-align: left; font-size: 14px; color: #840808; font-weight: 600;"></div>
                        </div> 
                      </div>
                      ...
                      <div style="display: flex; flex-direction: row; align-items: center; justify-content: center; width: 30vw;">
                        <div class="form-group" style="width: 30vw;">
                          <div style="text-align: left; font-size: 14px; color: #696969; font-weight: 600;">Description</div>
                          <div class='input-group'>
                            <textarea id="network_desc_edit" name="network_desc_edit" class="form-control" class="form-control" placeholder="Description" style="font-size: 14px;"> </textarea>
                          </div>
                        </div>  
                      </div>
                      ...
                      <div style="display: flex; flex-direction: row; align-items: center; justify-content: flex-start; width: 30vw;">
                        <div class="form-group" style="width: 15vw;">
                          <input type="hidden" id="network_type_edit" name="network_type_edit">
                          <div style="text-align: left; font-size: 14px; color: #696969; font-weight: 600;">* Type</div>
                          <div class="dropdown" style="">
                                <button class="btn btn-default dropdown-toggle" type="button" id="network_type_dropdown_edit" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="font-size: 14px; background-color: #fff; border: 1px solid #c3c3c3; width: 10vw; color: #696969; width: 15vw; text-align: left;">
                                    Network Type
                                </button>
                                <div class="dropdown-menu" id="network_type_options_edit" aria-labelledby="network_type_dropdown">
                                    <a class="dropdown-item" style="" data-value="PSK">
                                      <span class="title_text_dropdown" style="font-size: 14px; font-weight: 600;">Pre-Shared Key (PSK)</span><br/><span class="sub_text_dropdown" style="font-size: 12px; font-weight: 400;">Requires users to enter passphrase (that you have defined for the network) to connect</span>
                                    </a>
                                    <a class="dropdown-item" style="" data-value="CaptivePortal">
                      ...
                      <div style="display: flex; flex-direction: row; align-items: center; justify-content: flex-start; width: 30vw;">
                        <div class="form-group" style="width: 20vw;">
                          <div style="text-align: left; font-size: 14px; color: #696969; font-weight: 600;">VLAN</div>
                          <div class='input-group'>
                            <input type="text" id="network_vlan_edit" name="network_vlan_edit" class="form-control form-fields" class="form-control" placeholder="VLAN" style="font-size: 14px;"/>
                          </div>
                        </div> 
                      </div>
                    </div>
                    <!-- PSK Option Step: Page 1 (PSK Settings) -->
                    <div style="display: none; flex-direction: column;" class="form_class_edit form_step_2_edit" form-step='form_step_2_edit'>
                      <div style="display: flex; flex-direction: row; align-items: center; justify-content: flex-start; width: 30vw;">
                        <div class="form-group" style="width: 20vw;">
                          <div style="text-align: left; font-size: 14px; color: #696969; font-weight: 600;">* Passphrase</div>
                          <div class='input-group'>
                            <input type="text" id="backup_passphrase_edit" name="backup_passphrase_edit" class="form-control form-fields" placeholder="Pre-Shared Key" style="font-size: 14px;"/>
                          </div>
                        </div>  
                      </div>
                      ...
                      <div style="display: flex; flex-direction: row; align-items: center; justify-content: flex-start; width: 30vw;">
                        ...
                        <div class="form-group" style="width: 15vw;">
                          <input type="hidden" id="security_protocol_edit" name="security_protocol_edit">
                          <div style="text-align: left; font-size: 14px; color: #696969; font-weight: 600;">* Security Protocol</div>
                          <div class="dropdown sp_dropdown_edit" style="">
                            <button class="btn btn-default dropdown-toggle sp_dropdown_edit_btn" type="button" data-toggle="dropdown" aria-haspopup="   true" aria-expanded="false" style="font-size: 14px; background-color: #fff; border: 1px solid #c3c3c3; width: 10vw; color: #696969; width: 15vw; text-align: left;">
                              Select
                            </button>
                            <div class="dropdown-menu" id="sp_dropdown_options_edit" aria-labelledby="sp_dropdown">
                              <a class="dropdown-item" style="" data-value="WPA2"><span class="title_text_dropdown" style="font-size: 14px; font-weight: 600;">WPA2 (Recommended)</span></a>
                              <a class="dropdown-item" style="" data-value="WPA"><span class="title_text_dropdown" style="font-size: 14px; font-weight: 600;">WPA</span></a>
                            </div>
                          </div>
                      ...
                      <div style="display: flex; flex-direction: row; align-items: center; justify-content: flex-start; width: 30vw;">
                        ...
                        <div class="form-group" style="width: 15vw; display: none;">
                          <input type="hidden" id="passphrase_format_edit" name="passphrase_format_edit" value='0'>
                          <div style="text-align: left; font-size: 14px; color: #696969; font-weight: 600;">* Passphrase Format</div>
                          <div class="dropdown sp_dropdown" style="">
                            <button class="btn btn-default dropdown-toggle" type="button"id="pf_dropdown" data-toggle="dropdown" aria-haspopup="   true" aria-expanded="false" style="font-size: 14px; background-color: #fff; border: 1px solid #c3c3c3; width: 10vw; color: #696969; width: 15vw; text-align: left;">
                              Select
                      ...
                      <div style="display: none; flex-direction: row; align-items: center; justify-content: flex-start; width: 30vw;">
                        ...
                        <div class="form-group" style="width: 10vw;">
                          <div style="text-align: left; font-size: 14px; color: #696969; font-weight: 600;">* Passphrase Length</div>
                          <div class='input-group'>
                            <input type="text" id="passphrase_length_edit" name="passphrase_length_edit" class="form-control form-fields" placeholder="Number" style="font-size: 14px;" value="0"/>
                          </div>
                        </div> 
                      ...
                      <div style="display: flex; flex-direction: row; align-items: center; justify-content: flex-start; width: 30vw;">
                        ...
                        <div class="form-group" style="width: 15vw;">
                          <input type="hidden" id="passphrase_expiry_edit" name="passphrase_expiry_edit">
                          <div style="text-align: left; font-size: 14px; color: #696969; font-weight: 600;">* Passphrase Expiration</div>
                          <div class="dropdown pe_dropdown_edit" style="">
                            <button class="btn btn-default dropdown-toggle" type="button"id="pe_dropdown_edit_btn" data-toggle="dropdown" aria-haspopup="   true" aria-expanded="false" style="font-size: 14px; background-color: #fff; border: 1px solid #c3c3c3; width: 10vw; color: #696969; width: 15vw; text-align: left;">
                              Select
                            </button>
                            <div class="dropdown-menu" id="pe_dropdown_options_edit" aria-labelledby="pe_dropdown">
                              <a class="dropdown-item" style="" data-value="unlimited"><span class="title_text_dropdown" style="font-size: 14px; font-weight: 600;">Unlimited</span></a>
                              <a class="dropdown-item" style="" data-value="1-day"><span class="title_text_dropdown" style="font-size: 14px; font-weight: 600;">1 day</span></a>
                              <a class="dropdown-item" style="" data-value="2-days"><span class="title_text_dropdown" style="font-size: 14px; font-weight: 600;">2 days</span></a>
                              <a class="dropdown-item" style="" data-value="1-week"><span class="title_text_dropdown" style="font-size: 14px; font-weight: 600;">1 week</span></a>
                    ...
                    <!-- Venues Option Step: (Last Step) -->
                    <div style="display: none; flex-direction: column; padding-bottom: 50px;" class="form_class_edit form_step_6_edit" form-step='form_step_6_edit'>   
                      <p style="font-size: 13px; font-weight: 600;">Select venues to activate this network</p>
                      <table id="venues_network_table_edit" class="table table-bordered" id="dataTable_edit" width="45vw" cellspacing="0" style="font-size: 13px;">
                        <thead>
                          <tr>
                            <th>Venue Name</th>
                            <th>Address</th>
                    ...
                    <div style="display: flex; flex-direction: row; align-items: center; justify-content: flex-start; width: 30vw;">
                      <div class="form-group" style="text-align: center;">
                        <button type="submit" name="btn_back" id="btn_back_step_edit" class="btn btn-secondary btn-back-class" style="display: none; margin-top:15px; border-color: #f2f2f2; margin-right: 5px; background-color: #f2f2f2; color: #696969;">Back</button>
                        <button type="submit" name="btn_next" id="btn_next_step_edit" class="btn btn-secondary btn-next-class" style="margin-top:15px; " disabled>Next</button>
                      </div>  
                    </div>
                  ...
                  <!-- Right Section Progress-Bars --> 
                  <div style="display: flex; flex-direction: column; align-items: flex-start; justify-content: flex-start; width: 30%; padding-left: 30px; padding-top: 15px;" id="right_flow_0_edit" class="flow_section_edit">
                    <div style="display: flex; flex-direction: row; align-items: center; justify-content: flex-start;">
                      <div style="position: relative; width: 30px; height: 30px; border-radius: 15px; background-color: #b3b3b3; text-align: center; font-size: 12px; display: flex; justify-content: center; align-items: center; color: #fff; font-weight: 600;">1<div style="position: absolute; height: 40px; width: 1px; background-color: #b3b3b3; top: 120%"></div></div>
                      <span style="font-size: 14px; font-weight: 600; padding-left: 10px; color: #696969;">Network Settings</span>
                    </div>
                  ...
                  <!-- PSK Flow -->
                  <div style="display: none; flex-direction: column; align-items: flex-start; justify-content: flex-start; width: 30%; padding-left: 30px; padding-top: 30px;" id="right_flow_1_edit" class="flow_section_edit">
                    <div style="display: flex; flex-direction: row; align-items: center; justify-content: flex-start;">
                      <div class="circle_step_1_edit" style="position: relative; width: 30px; height: 30px; border-radius: 15px; background-color: #b3b3b3; text-align: center; font-size: 12px; display: flex; justify-content: center; align-items: center; color: #fff; font-weight: 600;">1<div style="position: absolute; height: 40px; width: 1px; background-color: #b3b3b3; top: 120%"></div></div>
                      <span class="title_step_1_edit" style="font-size: 14px; font-weight: 600; padding-left: 10px; color: #696969;">Network Settings</span>
                    </div>
                    
                    <div style="height: 50px;"></div>
                    <div style="display: flex; flex-direction: row; align-items: center; justify-content: flex-start;">
                      <div class="circle_step_2_edit" style="position: relative; width: 30px; height: 30px; border-radius: 15px; background-color: #b3b3b3; text-align: center; font-size: 12px; display: flex; justify-content: center; align-items: center; color: #fff; font-weight: 600;">2<div style="position: absolute; height: 40px; width: 1px; background-color: #b3b3b3; top: 120%"></div></div>
                      <span class="title_step_2_edit" style="font-size: 14px; font-weight: 600; padding-left: 10px; color: #696969;">PSK Settings</span>
                    </div>
                  ...
                  <!-- CaptivePortal Flow -->
                  <div style="display: none; flex-direction: column; align-items: flex-start; justify-content: flex-start; width: 30%; padding-left: 30px; padding-top: 30px;" id="right_flow_2_edit" class="flow_section_edit">
                    <div style="display: flex; flex-direction: row; align-items: center; justify-content: flex-start;">
                      <div style="position: relative; width: 30px; height: 30px; border-radius: 15px; background-color: #b3b3b3; text-align: center; font-size: 12px; display: flex; justify-content: center; align-items: center; color: #fff; font-weight: 600;">1<div style="position: absolute; height: 15px; width: 1px; background-color: #b3b3b3; top: 120%"></div></div>
                      <span style="font-size: 14px; font-weight: 600; padding-left: 10px; color: #696969;">Network Settings</span>
                    </div>
            ...
            <div id="error_msg_edit" class="row" style="display: none;">
              <div class="col-md-12">
                <p id="error_text" style="font-size: 14px; color: #840808; padding-left: 80px; padding-top: 0px; text-align: left; font-weight: 600;"></p>
              </div>
            </div>
            <div id="success_msg_edit" class="row" style="display: none;">
              <div class="col-md-12">
                <p style="font-size: 14px; color: #636363; padding-left: 80px; padding-top: 0px; text-align: left; font-weight: 600;">Wifi Network updated &#10003;</p>
              </div>
            </div>
